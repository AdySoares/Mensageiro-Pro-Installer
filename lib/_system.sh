...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código Mensageiro-Pro...${GRAY_LIGHT}"
  printf "\n\n"

  sleep 2

  su - ${user_system} <<EOF
  git clone https://github.com/AdySoares/Mensageiro-Pro.git  /home/${user_system}/${instancia_add}/
EOF
