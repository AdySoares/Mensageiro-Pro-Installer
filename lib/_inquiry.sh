...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao instalador Mensageiro-Pro, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar o Mensageiro-Pro\n"
  printf "   [2] Atualizar o Mensageiro-Pro\n"
